<!-- ============================================================
  App.vue — NEW DESIGN reskin (single iStar theme)
  Drop-in replacement for src/App.vue
  • <template> + <script> = UNCHANGED (nav logic / usertype routing kept).
  • Appended <style> themes the navigation drawer (pink gradient) + app bar.
...
<style scoped>
/* === iStar NEW DESIGN reskin — app shell === */
:deep(.v-navigation-drawer){ background: var(--sidebar-bg) !important; color: var(--sidebar-tx) !important; border: none !important; }
:deep(.v-navigation-drawer .v-list-item){ color: var(--sidebar-tx) !important; border-radius: var(--radius-md) !important; margin: 2px 8px; }
:deep(.v-navigation-drawer .v-list-item--active){ background: var(--sidebar-active-bg) !important; color: var(--sidebar-active-tx) !important; }
:deep(.v-navigation-drawer .v-list-item:hover){ background: var(--sidebar-hover-bg) !important; }
:deep(.v-navigation-drawer .v-icon), :deep(.v-navigation-drawer .v-list-subheader){ color: inherit !important; opacity: .95; }
:deep(.v-app-bar){ background: var(--topbar-bg) !important; -webkit-backdrop-filter: blur(12px); backdrop-filter: blur(12px); border-bottom: 1px solid var(--topbar-border) !important; box-shadow: var(--shadow-sm) !important; }
:deep(.v-app-bar-title){ font-family: var(--font-head) !important; font-weight: 800 !important; color: var(--c-text-heading) !important; }
:deep(.v-btn){ border-radius: var(--radius-md) !important; text-transform: none !important; font-weight: 700 !important; }
:deep(.v-main){ background: transparent !important; }
</style>
